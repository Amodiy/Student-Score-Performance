...
#setting the page
st.set_page_config(page_title='Business Analytics Dashboard', page_icon='https://cdn-icons-png.freepik.com/512/2072/2072130.png', layout='wide')
